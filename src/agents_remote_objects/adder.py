...
class Adder:
    ...
    def receive_list_agents(self, data: dict):
        print("The adder agent receives from the Yellow Page the agent directory encrypted.\n " + str(data) + "\n")
    ...
    def execute(self, data: dict):
        ...
        if data_desencrypted["num1"] and data_desencrypted["num2"]:
            print("The sum agents_remote_objects.py has received: " + str((data_desencrypted["num1"], data_desencrypted["num2"])) + "\n")
            result = data_desencrypted["num1"] + data_desencrypted["num2"]
            print("The adder agents_remote_objects is sending: " + str(result) + "\n")
