...
class Division:
    ...
    def ping(self, data: dict):
        print("The division agent receives a ping from the Yellow Page.\n " + str(data))
    ...
    def execute(self, data: dict):
        ...
        if data_desencrypted["num1"] and data_desencrypted["num2"]:
            print("The division agents.py has received: " + str((data_desencrypted["num1"], data_desencrypted["num2"])))
